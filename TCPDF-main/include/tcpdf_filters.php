...
class TCPDF_FILTERS {
	...
	/**
	 * Define a list of availability filter decoders.
	 * @private static
	 */
	private static $availability_filters = array('ASCIIHexDecode', 'ASCII85Decode', 'LZWDecode', 'FlateDecode', 'RunLengthDecode');

// -----------------------------------------------------------------------------

	/**
	 * Get a list of availability decoding filters.
	 * @return array Array of availability filter decoders.
	 * @since 1.0.000 (2011-05-23)
	 * @public static
	 */
	public static function getAvailabilityFilters() {
		return self::$availability_filters;
	}
